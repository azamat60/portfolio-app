...
export const projects: Project[] = [
  ...
  // ── Pet ───────────────────────────────────────────────────────────────────
  {
    id: 'csv-auto-dashboard',
    name: 'CSV Insight Dashboard',
    initials: 'CSV',
    desc: 'Interactive client-side CSV analytics dashboard with instant profiling, filters, charts, saved views, and a paginated data table.',
    descRu: 'Интерактивный client-side дашборд для CSV-аналитики: profiling, фильтры, графики, saved views и пагинированная таблица без бэкенда.',
    longDesc: 'CSV Insight Dashboard is an interactive, client-side CSV analytics dashboard built with React and TypeScript. Upload a CSV and get instant column profiling, filters, charts, saved views, and a paginated data table without sending data to a backend. Processing happens fully in the browser, while the last dataset and saved views persist in localStorage.',
    longDescRu: 'CSV Insight Dashboard — интерактивный client-side дашборд для CSV-аналитики на React и TypeScript. Загрузите CSV и сразу получите profiling колонок, фильтры, графики, saved views и пагинированную таблицу без отправки данных на бэкенд. Вся обработка происходит в браузере, последний датасет и сохранённые views хранятся в localStorage.',
    stack: ['React 19', 'TypeScript', 'Vite', 'Zustand', 'Recharts', 'Tailwind CSS', 'Vitest'],
    type: 'pet',
    year: '2026',
    role: 'Solo',
    status: 'Shipped',
    colors: ['#0f172a', '#2563eb'],
    image: '/projects/csv-auto-dashboard.png',
    features: [
      'Local CSV upload and sample dataset mode',
      'Smart column profiling for number, date, string, boolean, and id-like fields',
      'Auto-generated summary cards and insight charts',
      'Filter system with global search, date range, category checkboxes, numeric ranges, and chart selection',
      'Saved views with save, apply, delete, export, and import flows',
      'Dataset reset flow with confirmation modal',
      'Light and dark theme toggle',
      'Fully browser-side data processing with localStorage persistence',
    ],
    featuresRu: [
      'Локальная загрузка CSV и режим sample dataset',
      'Умный profiling колонок: number, date, string, boolean и id-like поля',
      'Автоматические summary cards и insight charts',
      'Фильтры: global search, date range, category checkboxes, numeric ranges и выбор через графики',
      'Saved views: save, apply, delete, export и import',
      'Reset датасета через confirmation modal',
      'Переключение light/dark темы',
      'Полностью браузерная обработка данных с сохранением в localStorage',
    ],
    demoUrl: 'https://www.azamatdev.com/csv-auto-dashboard',
    sourceUrl: null,
  },
  {
    id: 'habbit-tracker',
